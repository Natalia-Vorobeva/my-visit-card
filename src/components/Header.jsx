...
useEffect(() => {
  ...
  const handleScroll = () => {
    ...
    // Определяем активную секцию на главной ИЛИ на странице contact
 ...
 const handleSectionClick = (sectionId) => {
  ...
  // Если мы на главной ИЛИ на странице contact (которая тоже главная)
  if (location.pathname === '/' || location.pathname === '/contact') {
    // Если уже на главной/contact, просто скроллим
