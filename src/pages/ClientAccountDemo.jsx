...
import { useNavigate } from 'react-router-dom'; // Изменяем с Link на useNavigate
import {
...
const ClientAccountDemo = () => {
	...
	const handleNavigateToPricing = (e) => {
		e.preventDefault();
		navigate('/', {
			state: { scrollToSection: 'playground' },
			replace: true
		});
	};
												...
												<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
													<div>
														<div className="flex items-center gap-3 mb-2">
															...
															<div className={`px-3 py-1 rounded-full text-xs font-semibold ${order.status === 'completed' ? 'bg-green-100 text-green-800' :
								...
								>
									...
									<div className="space-y-4">
										{[
											...
											<div key={idx} className={`p-4 border rounded-xl cursor-pointer hover:bg-gray-50 ${msg.unread ? 'border-blue-300 bg-blue-50' : ''
												}`}>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:shadow-xl transition-all cursor-pointer"
              >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-white/20 backdrop-blur-sm border border-white/30 text-white font-bold rounded-xl hover:bg-white/30 transition-all cursor-pointer"
              >
